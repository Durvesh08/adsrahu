    ...
    <div className="flex flex-col min-h-screen pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white mb-6 leading-tight">
              Performance Marketing & Lead Generation Systems For <span className="text-gradient-blue">Real Estate</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
              <Link href="/book-a-call" className="w-full sm:w-auto inline-flex h-12 items-center justify-center rounded-md bg-primary px-8 text-base font-medium text-white shadow transition-all hover:bg-primary/90 glow-blue">
                <Phone className="mr-2 h-4 w-4" /> Book Free Strategy Call
              </Link>
              <a href="https://wa.me/917485022937" target="_blank" rel="noreferrer" className="w-full sm:w-auto inline-flex h-12 items-center justify-center rounded-md border border-white/20 bg-white/5 backdrop-blur-md px-8 text-base font-medium text-white shadow-sm transition-all hover:bg-white/10 hover:border-green-500/50 group">
          ...
          >
            {/* Fake Dashboard UI */}
            <div className="relative rounded-xl border border-white/10 bg-[#0d0d14]/80 backdrop-blur-xl shadow-2xl overflow-hidden aspect-[4/3] p-6 glow-blue-strong transform rotate-y-[-10deg] rotate-x-[5deg] perspective-1000">
              ...
              <div className="rounded-lg bg-white/5 p-4 border border-white/5 h-32 flex items-end gap-2 px-6">
                {[40, 65, 45, 80, 55, 90, 75].map((h, i) => (
                  <div key={i} className="w-full bg-primary/40 rounded-t-sm relative group">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              ...
              <div key={i} className="rounded-xl border border-white/10 bg-[#0d0d14] p-6 text-center hover:bg-white/5 transition-colors group">
                <div className="text-3xl font-bold text-white mb-2 group-hover:text-primary transition-colors">{stat.value}</div>
      ...
      <section className="py-24 bg-[#050505] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="rounded-2xl border border-primary/30 bg-primary/5 p-8 backdrop-blur-sm glow-blue relative overflow-hidden">
      ...
      <section className="py-32 bg-black relative border-y border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Real Estate Lead Generation Experts</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className={`rounded-xl border p-6 transition-all duration-300 ${i === 0 || i === 4 ? 'border-primary/50 bg-[#0d0d14] glow-blue' : 'border-white/10 bg-[#050505] hover:border-white/30'}`}>
                <service.icon className={`w-8 h-8 mb-4 ${i === 0 || i === 4 ? 'text-primary' : 'text-gray-400'}`} />
            ...
            {["Ads", "Landing Page", "WhatsApp", "CRM", "Sales"].map((step, i, arr) => (
              <React.Fragment key={i}>
                <div className="relative group">
                  ...
                  <div className="w-40 h-24 rounded-xl border border-white/20 bg-[#0d0d14] flex items-center justify-center text-white font-semibold relative z-10 hover:border-primary transition-colors">
                    {step}
                  </div>
                </div>
                {i < arr.length - 1 && (
                  <div className="hidden md:block w-8 h-0.5 bg-gradient-to-r from-primary/50 to-primary/20 relative">
                    <ArrowRight className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-4 h-4 text-primary" />
                  </div>
                )}
                {i < arr.length - 1 && (
                  <div className="md:hidden h-8 w-0.5 bg-gradient-to-b from-primary/50 to-primary/20 relative my-2">
      ...
      <section className="py-24 bg-[#050505]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl border border-white/10 bg-[#0d0d14] overflow-hidden flex flex-col md:flex-row shadow-2xl">
            ...
            <div className="w-full md:w-3/5 p-8 md:p-12 flex flex-col justify-center relative">
              <div className="absolute -top-24 -right-24 w-48 h-48 bg-primary/20 blur-[60px]" />
              <h2 className="text-gold font-semibold text-sm tracking-wider uppercase mb-2">Meet The Founder</h2>
              <h3 className="text-3xl font-bold text-white mb-4">Raushan Pratap Yadav</h3>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1" className="border-white/10">
              <AccordionTrigger className="text-white hover:text-primary hover:no-underline text-left">How fast can I start getting leads?</AccordionTrigger>
            ...
            <AccordionItem value="item-2" className="border-white/10">
              <AccordionTrigger className="text-white hover:text-primary hover:no-underline text-left">Do you provide CRM and WhatsApp automation?</AccordionTrigger>
              <AccordionContent className="text-gray-400 text-base">
            ...
            <AccordionItem value="item-3" className="border-white/10">
              <AccordionTrigger className="text-white hover:text-primary hover:no-underline text-left">Do you work only with real estate businesses?</AccordionTrigger>
              <AccordionContent className="text-gray-400 text-base">
            ...
            <AccordionItem value="item-4" className="border-white/10">
              <AccordionTrigger className="text-white hover:text-primary hover:no-underline text-left">Do you work with international clients?</AccordionTrigger>
              <AccordionContent className="text-gray-400 text-base">
            ...
            <AccordionItem value="item-5" className="border-white/10">
              <AccordionTrigger className="text-white hover:text-primary hover:no-underline text-left">What services do you provide?</AccordionTrigger>
              <AccordionContent className="text-gray-400 text-base">
      ...
      <section className="py-32 relative overflow-hidden bg-black">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Ready To Generate More Leads & Scale Faster?</h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/book-a-call" className="w-full sm:w-auto inline-flex h-14 items-center justify-center rounded-md bg-white px-8 text-base font-bold text-black shadow transition-all hover:bg-gray-200">
              Book Strategy Call
            </Link>
            <a href="https://wa.me/917485022937" target="_blank" rel="noreferrer" className="w-full sm:w-auto inline-flex h-14 items-center justify-center rounded-md border border-white/20 bg-black px-8 text-base font-medium text-white shadow-sm transition-all hover:bg-white/10 hover:border-green-500/50 group">
