        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sql(templateObject_1 || (templateObject_1 = __makeTemplateObject(["SELECT * FROM bookings ORDER BY created_at DESC"], ["SELECT * FROM bookings ORDER BY created_at DESC"])))];
                case 1:
                    rows = _e.sent();
                ...
                case 2:
                    ...
                    if (!b.name || !b.phone || !b.date || !b.time) {
                        res.status(400).json({ error: "name, phone, date and time required" });
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, sql(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      INSERT INTO bookings (name, phone, email, date, time, status, notes)\n      VALUES (", ", ", ", ", ", ", ", ", ", ", ", ", ")\n      RETURNING *"], ["\n      INSERT INTO bookings (name, phone, email, date, time, status, notes)\n      VALUES (", ", ", ", ", ", ", ", ", ", ", ", ", ")\n      RETURNING *"])), b.name, b.phone, (_b = b.email) !== null && _b !== void 0 ? _b : "", b.date, b.time, (_c = b.status) !== null && _c !== void 0 ? _c : "pending", (_d = b.notes) !== null && _d !== void 0 ? _d : "")];
                case 3:
                    rows = _e.sent();
