        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, sql(templateObject_2 || (templateObject_2 = __makeTemplateObject(["DELETE FROM blog_posts WHERE id = ", ""], ["DELETE FROM blog_posts WHERE id = ", ""])), id)];
                case 3:
                    _c.sent();
                    res.status(204).end();
                    return [2 /*return*/];
